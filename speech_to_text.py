...
def pronounciation_score(audio):
...
alpha= './deepspeech-0.6.1-models/alphabet.txt'
lm_alpha = 0.75
lm_beta = 1.85

ds = Model('./deepspeech-0.6.1-models/output_graph.pbmm',500)    ### ds = Model(args.model, args.beam_width)

desired_sample_rate = ds.sampleRate()


ds.enableDecoderWithLM(alpha, lm, trie, lm_alpha, lm_beta)
...
file_generated = pronounciation_score(audio)
